...
ALTER TABLE tasks ADD COLUMN IF NOT EXISTS gate_type   TEXT DEFAULT 'Gate';
ALTER TABLE tasks ADD COLUMN IF NOT EXISTS is_gauntlet BOOLEAN DEFAULT FALSE;
ALTER TABLE tasks ADD COLUMN IF NOT EXISTS is_weekly_trial BOOLEAN DEFAULT FALSE;
...
ALTER TABLE tasks ADD COLUMN IF NOT EXISTS recurrence_day_of_month INTEGER DEFAULT 1;
ALTER TABLE tasks ADD COLUMN IF NOT EXISTS recurrence_custom_label TEXT;
